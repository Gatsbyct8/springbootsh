...
import com.sh.sso.service.UserService;
...
public class UserController {
	...
	@ResponseBody
	public SysResult doLogin(@RequestParam("u") String phone,String p) throws Exception{
		//业务层user信息保存到redis的key值ticket
		String ticket=userService.doLogin(phone,p);
