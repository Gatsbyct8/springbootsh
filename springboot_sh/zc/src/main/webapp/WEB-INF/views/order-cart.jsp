...
<!--shortcut end-->
	<form id="orderForm" action="/order/submit" >
		...
		<table class="order-table">
			...
			<c:forEach items="${carts}" var="cart">
				  <tr>
				    <td class="fore1">
					   <div class="p-goods">
						  <div class="p-img"><a href="http://localhost:8090/product_details/${cart.commodityId}.html" target='_blank'><img width="52" height="52" src="../${cart.mianImage}"></a></div>
							 <div class="p-detail">
								<div class="p-name">
									<a href="http://localhost:8090/product_details/${cart.commodityId}.html" target='_blank'>
										${cart.name }
								    </a>
								</div>
								<div class="p-more">商品编号：${cart.commodityId}<br />
																	<!-- icon图标预留-->
								<span id="promise_1057746" class="promise411"></span>
					  				  ...
					  				  <td class="p-price"><strong>￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${cart.price}"/></strong>
					  </td>
					  				  <td class="p-promotion"> </td>
					  <td class="fore2">x ${cart.count }</td>
...
<!--**********商品清单内容列表结束************-->
										...
										<div class="order-summary">
											...
											<div class="statistic fr">
                                                <div class="list"><span><em id="span-skuNum">1</em> 件商品，总商品金额：</span><em class="price" id="warePriceId" v="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice}"/>">￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/1000 }"/></em></div>
                                                ...
                                                <div class="list"><span>应付总额：</span><em id="sumPayPriceId" class="price"> ￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice}"/></em></div>			
											</div>
						...
						<div id="checkout-floatbar" class="checkout-buttons group">
							<div class="inner">
                                ...
                                <input type="submit" class="checkout-submit" value="提交" id="order-submit" onclick="javascript:submit_Order();"/>
                                        提交订单
                                        <b></b>
                                </button>
																	<span class="total">应付总额：<strong id="payPriceId">￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice}"/></strong>元 
	    							</span>
